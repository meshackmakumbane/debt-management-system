      ...
      <>
          ...
          <header className="relative flex flex-col items-center bg-black text-white px-4 overflow-hidden">
              ...
              <div className="flex items-center gap-4 mt-8">
                  <Link to="/get-started" className="bg-emerald-400 active:scale-95 hover:bg-emerald-500 transition px-6 py-2.5 text-sm font-medium rounded-full cursor-pointer">
                      Live Demo
                  </Link>
