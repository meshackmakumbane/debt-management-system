...
const NotFound = () => {
  return (
    <div className="flex flex-col items-center justify-center text-sm h-[400px]">
        <p className="font-medium text-lg text-green-700">404 Error</p>
        ...
        <div className="flex items-center gap-4 mt-6">
            <Link to='/' className="bg-green-700 hover:bg-green-500 px-7 py-2.5 text-white rounded active:scale-95 transition-all">
                Go back home
            </Link>
            <Link to='/' className="group flex items-center gap-2 px-7 py-2.5 active:scale-95 transition">
                Contact support
